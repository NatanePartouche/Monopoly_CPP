...
ChanceCard::ChanceCard()
    : owner(dummyPlayer2), board(dummyBoard2) {}

// Constructor that initializes with actual player and board references
ChanceCard::ChanceCard(Player &owner, Board &board)
...
// Initialize all the actions related to the Chance cards
void ChanceCard::initActions(Player &owner, Board &board) {
...
// Draw a random Chance card and execute the associated action
void ChanceCard::drawCard() {
